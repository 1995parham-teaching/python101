...
\begin{frame}[fragile]
	\frametitle{Employees Inheritance}
  \inputminted[bgcolor=Black,fontsize=\scriptsize,lastline=21]{python}{./src/employee_2.py}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Employees Inheritance (Cont'd)}
  \inputminted[bgcolor=Black,fontsize=\scriptsize,firstline=23,lastline=29]{python}{./src/employee_2.py}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Employees Inheritance (Cont'd)}
  \inputminted[bgcolor=Black,fontsize=\scriptsize,firstline=31,lastline=38]{python}{./src/employee_2.py}
\end{frame}
...
\begin{frame}[fragile]
	\frametitle{Employees Inheritance (Cont'd)}
  \inputminted[bgcolor=Black,fontsize=\scriptsize,firstline=40]{python}{./src/employee_2.py}
\end{frame}
